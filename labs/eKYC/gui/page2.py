...
class VerificationWindow(QDialog):
    def __init__(self, camera, main_window, parent=None):
        ...
        # set window size
        self.window_heigt = 1964
        self.window_width = 3224
    ...
    def rescale_image(self):
        ...
        return window_width // 4, window_height // 4  # Adjust scaling factor as needed
        ...
        if ret:
            ...
            if self.count_frame == 50:
                ...
                try:
                    ...
                    self.update_process_label(text=f"<font color=red>Error: {str(e)}</font>")
                    self.count_frame = 0
    ...
    def closeEvent(self, event):
        try:
            ...
            logging.error(f"Error while closing camera: {e}")
        finally:
            event.accept()
