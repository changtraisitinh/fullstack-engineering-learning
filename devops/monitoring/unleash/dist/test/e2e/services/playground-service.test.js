...
const segment_read_model_1 = require("../../../lib/features/segment/segment-read-model");
let stores;
let db;
let service;
...
beforeAll(async () => {
    ...
    const segmentReadModel = new segment_read_model_1.SegmentReadModel(db.rawDatabase);
