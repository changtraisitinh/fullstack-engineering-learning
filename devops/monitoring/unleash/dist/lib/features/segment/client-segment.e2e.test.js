...
const arraysHaveSameItems_1 = require("../../util/arraysHaveSameItems");
...
test('should store segment-created and segment-deleted events', async () => {
    ...
    await app.services.segmentService.delete(segment1.id, user, (0, util_1.extractAuditInfoFromUser)(user));
