...
const collect_ids_1 = require("../../util/collect-ids");
const database_init_1 = __importDefault(require("../../../test/e2e/helpers/database-init"));
const no_logger_1 = __importDefault(require("../../../test/fixtures/no-logger"));
const app_utils_1 = require("../../../test/e2e/helpers/app.utils");
...
beforeAll(async () => {
    ...
    db = await (0, database_init_1.default)('segments_api_serial', no_logger_1.default, customOptions);
    app = await (0, test_helper_1.setupAppWithCustomConfig)(db.stores, customOptions, db.rawDatabase);
});
afterAll(async () => {
    await app.destroy();
    await db.destroy();
...
test('should not delete segments used by strategies', async () => {
    ...
    await (0, app_utils_1.createFeatureFlag)(app, flag);
    const [segment] = await fetchSegments();
    await (0, app_utils_1.addStrategyToFeatureEnv)(app, { ...flag.strategies[0] }, 'default', flag.name);
...
test('should list strategies by segment', async () => {
    ...
    await (0, app_utils_1.createFeatureFlag)(app, flag1);
    await (0, app_utils_1.createFeatureFlag)(app, flag2);
    await (0, app_utils_1.createFeatureFlag)(app, flag3);
    await (0, app_utils_1.addStrategyToFeatureEnv)(app, { ...flag1.strategies[0] }, 'default', flag1.name);
    await (0, app_utils_1.addStrategyToFeatureEnv)(app, { ...flag1.strategies[0] }, 'default', flag2.name);
    await (0, app_utils_1.addStrategyToFeatureEnv)(app, { ...flag3.strategies[0] }, 'default', flag3.name);
    ...
    expect((0, collect_ids_1.collectIds)(segmentStrategies1.strategies)).toEqual((0, collect_ids_1.collectIds)(feature1Strategies));
    expect((0, collect_ids_1.collectIds)(segmentStrategies2.strategies)).toEqual((0, collect_ids_1.collectIds)([...feature1Strategies, ...feature2Strategies]));
    expect((0, collect_ids_1.collectIds)(segmentStrategies3.strategies)).toEqual((0, collect_ids_1.collectIds)([
        ...feature1Strategies,
        ...feature2Strategies,
        ...feature3Strategies,
    ]));
...
test('should list segments by strategy', async () => {
    ...
    //@ts-ignore
    feature3Strategy.id);
    expect((0, collect_ids_1.collectIds)(strategySegments1)).toEqual((0, collect_ids_1.collectIds)([segment1, segment2, segment3]));
    expect((0, collect_ids_1.collectIds)(strategySegments2)).toEqual((0, collect_ids_1.collectIds)([segment2, segment3]));
    expect((0, collect_ids_1.collectIds)(strategySegments3)).toEqual((0, collect_ids_1.collectIds)([segment3]));
});
...
describe('detect strategy usage in change requests', () => {
    ...
    const enterpriseFetchSegmentStrategies = (segmentId) => enterpriseApp.request
        ...
        .then((res) => res.body);
    beforeAll(async () => {
        enterpriseApp = await (0, test_helper_1.setupAppWithCustomConfig)(db.stores, {
    ...
    test('should not delete segments used by strategies in CRs', async () => {
        ...
        const flag = mockFeatureFlag();
        await (0, app_utils_1.createFeatureFlag)(enterpriseApp, flag);
    ...
    test('Should show segment usage in updateStrategy events', async () => {
        ...
        await (0, app_utils_1.createFeatureFlag)(enterpriseApp, flag);
        const [segment] = await enterpriseFetchSegments();
        await (0, app_utils_1.addStrategyToFeatureEnv)(enterpriseApp, { ...flag.strategies[0] }, 'default', flag.name);
        const [feature] = await fetchFeatures();
        const [strategy] = await fetchFeatureStrategies(feature.name);
