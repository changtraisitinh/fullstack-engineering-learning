...
class FeatureSearchStore {
    ...
    async searchFeatures({ userId, searchParams, status, offset, limit, sortOrder, sortBy, archived, favoritesFirst, }, queryParams) {
        ...
        const finalQuery = this.db
            ...
            (0, search_utils_1.applySearchFilters)(query, searchParams, [
                'features.name',
            ...
            if (!entry) {
                ...
                entry = {
                    ...
                    createdBy: {
                        ...
                        name: name,
                        imageUrl: (0, util_1.generateImageUrl)({
                            id: row.user_id,
...
const applyStaleConditions = (query, staleConditions) => {
    ...
    if (!values.includes('potentially-stale')) {
        (0, search_utils_1.applyGenericQueryParams)(query, [
            {
                ...staleConditions,
...
const applyQueryParams = (query, queryParams) => {
    ...
    (0, search_utils_1.applyGenericQueryParams)(query, genericConditions);
...
exports.default = FeatureSearchStore;
