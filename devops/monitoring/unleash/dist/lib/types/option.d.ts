...
export interface IUnleashOptions {
    ...
    isOss?: boolean;
    resourceLimits?: Partial<Pick<ResourceLimitsSchema, 'apiTokens' | 'constraintValues' | 'constraints' | 'environments' | 'featureEnvironmentStrategies' | 'featureFlags' | 'projects' | 'segments'>>;
