...
describe('OpenAPI error conversion', () => {
    it('Gives useful error messages for missing properties', () => {
        ...
        const result = (0, bad_data_error_1.fromOpenApiValidationError)({ body: {}, query: {} })(error);
    ...
    it('Gives useful enum error messages', () => {
        ...
        const result = (0, bad_data_error_1.fromOpenApiValidationError)(request)(error);
        expect(result).toMatchObject({
    ...
    it('Handles multiple errors', () => {
        ...
        const serializedUnleashError = (0, bad_data_error_1.fromOpenApiValidationErrors)({ body: { newprop: 7 }, query: {} }, errors).toJSON();
    ...
    it('Handles invalid data gracefully', () => {
        ...
        const serializedUnleashError = (0, bad_data_error_1.fromOpenApiValidationErrors)({}, errors).toJSON();
        expect(serializedUnleashError).toMatchObject({
            name: 'BadDataError',
            message: expect.stringContaining('`details`'),
            details: [
    ...
    describe('Disallowed additional properties', () => {
        it('gives useful messages for base-level properties', () => {
            ...
            const error = (0, bad_data_error_1.fromOpenApiValidationError)({
                body: { bogus: 5 },
                query: {},
            })(openApiError);
            expect(error).toMatchObject({
...
describe('Error serialization special cases', () => {
    ...
    it('BadDataError: adds `details` with error details', () => {
        ...
        const error = new bad_data_error_1.default(message).toJSON();
        expect(error).toMatchObject({
            details: [
                {
                    message,
