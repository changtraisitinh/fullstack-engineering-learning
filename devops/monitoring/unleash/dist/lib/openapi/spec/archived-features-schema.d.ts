...
export declare const archivedFeaturesSchema: {
    readonly $id: "#/components/schemas/archivedFeaturesSchema";
    readonly type: "object";
    readonly additionalProperties: false;
    readonly required: readonly ["version", "features"];
    readonly description: "A list of archived features";
    readonly properties: {
        readonly version: {
        ...
        readonly features: {
            readonly type: "array";
            readonly items: {
                readonly $ref: "#/components/schemas/archivedFeatureSchema";
            };
    ...
    readonly components: {
        readonly schemas: {
            readonly archivedFeatureSchema: {
...
//# sourceMappingURL=archived-features-schema.d.ts.map