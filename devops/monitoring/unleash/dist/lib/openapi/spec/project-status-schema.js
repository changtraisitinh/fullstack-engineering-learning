...
exports.projectStatusSchema = void 0;
const project_activity_schema_1 = require("./project-activity-schema");
...
exports.projectStatusSchema = {
    ...
    components: {
        schemas: {
            projectActivitySchema: project_activity_schema_1.projectActivitySchema,
        },
    },
};
