...
export declare const createApiTokenSchema: {
    ...
    readonly oneOf: readonly [import("json-schema-to-ts/lib/types/definitions").JSONSchema7, import("json-schema-to-ts/lib/types/definitions").JSONSchema7, import("json-schema-to-ts/lib/types/definitions").JSONSchema7, import("json-schema-to-ts/lib/types/definitions").JSONSchema7];
    readonly components: {};
};
