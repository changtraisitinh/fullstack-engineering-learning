...
const resource_limits_schema_1 = require("./resource-limits-schema");
exports.uiConfigSchema = {
    ...
    properties: {
        ...
        resourceLimits: {
            $ref: resource_limits_schema_1.resourceLimitsSchema.$id,
            description: resource_limits_schema_1.resourceLimitsSchema.description,
            example: {
                ...Object.entries(resource_limits_schema_1.resourceLimitsSchema.properties).reduce((acc, [prop, { example }]) => ({
                    ...acc,
                    [prop]: example,
                }), {}),
            },
    ...
    components: {
        schemas: {
            ...
            resourceLimitsSchema: resource_limits_schema_1.resourceLimitsSchema,
        },
    },
};
