...
const create_pat_schema_1 = require("./create-pat-schema");
exports.patSchema = {
    ...
    required: ['id', 'createdAt', ...create_pat_schema_1.createPatSchema.required],
    properties: {
        id: {
            type: 'integer',
        ...
        ...create_pat_schema_1.createPatSchema.properties,
    },
    components: {
        schemas: {},
    },
